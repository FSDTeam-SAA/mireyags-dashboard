              ...
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    ...
                    className="h-[148px] w-full rounded-[8px] border border-[#CECECE] text-base font-medium leading-normal text-[#1E1E1E] placeholder:text-[#CECECE]"
                    {...field}
                  />
                </FormControl>
                <FormMessage  className="text-red-500"/>
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="mb-3 flex items-center justify-between gap-3">
                <h3 className="text-lg font-medium leading-normal text-[#1E1E1E]">
                  Sub Images
                </h3>
...
//     const { data: brandData } = useQuery<BrandsApiResponse>(
//       {
//         queryKey: ["all-brands"],
//         queryFn: async () => {
//           const res = await fetch(
